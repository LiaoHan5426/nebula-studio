...
export const DEFAULT_ADDRESS_ALLOWLIST = [
  ...
  /^e2e[\\/]/,
  /^apps[\\/]mf-poc-host[\\/]/,
  /^internal[\\/]build-kit[\\/]src[\\/]config[\\/]defineNebulaSubAppConfig\.ts$/,
  /^internal[\\/]build-kit[\\/]src[\\/]federation[\\/]defineNebulaRemoteConfig\.ts$/,
  /^internal[\\/]build-kit[\\/]src[\\/]federation[\\/]nebulaHostDevRemotesPlugin\.ts$/,

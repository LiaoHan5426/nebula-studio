import { createFileSystemAdapter } from '../../host/adapters/file-system.adapter';
import type { FileSystemAdapter } from '../../host/adapters/file-system.adapter';
import { createShellAdapter } from '../../host/adapters/electron-shell.adapter';
import type { ShellAdapter } from '../../host/adapters/electron-shell.adapter';
...
import { registerBridgeHandlers } from './register';
...
export function setupBridgeMainRuntime(
  ...
  const fileSystemAdapter =
    options.fileSystemAdapter ?? createFileSystemAdapter();

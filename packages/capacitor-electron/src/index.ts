...
export {
  createMainDispatcher,
  type MainDispatcherOptions,
} from './bridge/main/dispatch';
export {
...
export {
  setupBridgeMainRuntime,
  type BridgeRuntimeOptions,
} from './bridge/main/runtime';
export {
...
export {
  createShellAdapter,
  type ShellAdapter,
} from './host/adapters/electron-shell.adapter';
export {
...
} from './shared/errors/bridge-error';
export {

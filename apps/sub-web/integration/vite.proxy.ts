...
export const proxy: Record<string, ProxyOptions> = {
  ...
  '/api/security/governance': withSse('http://localhost:8080'),
  '/api/version': withSse('http://localhost:8080'),
  '/api/release': withSse('http://localhost:8080'),
  '/api/releases': withSse('http://localhost:8080'),

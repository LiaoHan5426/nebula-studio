...
export interface IntegratedAppMeta extends ShellIntegratedAppMeta {
  id: EmbeddedShellWindowId;
}

export const INTEGRATED_APPS: IntegratedAppMeta[] = [
  {
    id: 'docs',
    label: '文档',
...
export const INTEGRABLE_ORDER: EmbeddedShellWindowId[] = [
  'docs',
  'integration',
  'settings',
];
